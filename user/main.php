...
session_start();
  ...
  $sess_passport = $_SESSION['passport'];
  $sess_surname = $_SESSION['surname'];
  $sess_userid =  $_SESSION['admin_id'];
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="../img/userimg/<?php echo $sess_passport ?>" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Welcome,</span>
                <h2><?php echo "$sess_surname"; ?></h2>
              </div>
              <div class="clearfix"></div>
            </div>
            <!-- /menu profile quick info -->
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-building"></i> Property Management <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="?mod=view&link=userproperty">View all Your acquired Properties</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="passport/<?php echo $sess_passport ?>" alt=""><?php echo "$sess_username"; ?>
        ...
        }elseif(isset($_GET['mod']) && $_GET['mod'] == 'view' && isset($_GET['link']) && $_GET['link'] == 'userproperty'){
          include'pages/viewuserproperties.php';
