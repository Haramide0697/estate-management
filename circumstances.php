                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul>
                                ...
                                <li><a href="circumstances.php">Circumstances</a></li>
                                <li><a href="index.php">Buyer Locations</a></li>
                                <li><a href="index.php">Property News</a></li>
...
<section class="south-editor-area d-flex align-items-center" id="questions">
        ...
        <div class="editor-content-area" style="text-align: justify;">
            ...
            <h2>Property in poor condition</h2>
            ...
            <h2>Formal Offer, Exchange & Completion</h2>
            ...
            <h2>House Sale Options</h2>
            <h2>What Are My Options When Selling With Ready Steady Sell?</h2>
            ...
            <h2>Choosing A Reputable House Buying Company To Sell Your Home</h2>
            ...
            <div class="address wow fadeInUp" data-wow-delay="750ms">
                ...
                <h6><img src="img/icons/envelope.png" alt=""> office@vp.com</h6>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-xl-3">
                        <div class="footer-widget-area mb-100">
                            ...
                            <!-- Address -->
                            <div class="address">
                                <h6><img src="img/icons/phone-call.png" alt=""> +234 123 456 789</h6>
                                <h6><img src="img/icons/envelope.png" alt=""> office@gp.com</h6>
                                <h6><img src="img/icons/location.png" alt=""> Location </h6>
                            </div>
                        </div>
                    </div>
